...
public class Cell {
    ...
    public bool PlayerCanWalk => terrain == TerrainType.Floor || occupant != Occupant.Empty;
    
    /// <summary>Can a crate be pushed here? (Floor or fillable Hole)</summary>
    public bool CanReceiveCrate => (terrain == TerrainType.Floor || terrain == TerrainType.Hole) 
