...
public class SokobanMove {
    ...
    public static SokobanMove CratePush(Vector2Int playerFrom, Vector2Int playerTo, 
                                       Vector2Int crateFrom, Vector2Int crateTo) {
        return new SokobanMove {
            playerFrom = playerFrom,
            playerTo = playerTo,
            crateFrom = crateFrom,
            crateTo = crateTo,
            direction = (crateTo - crateFrom).ToVector2Int(),
